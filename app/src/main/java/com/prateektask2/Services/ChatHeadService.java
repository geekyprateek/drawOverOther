...
import com.prateektask2.Activities.MyDialog;
...
public class ChatHeadService extends Service {
    ...
    private void chathead_click(){
        if(MyDialog.active){
            ...
            Intent it = new Intent(this,MyDialog.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP).putExtra("appname",appname);
            startActivity(it);
        }
